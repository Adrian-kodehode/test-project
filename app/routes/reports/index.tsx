      ...
      <main className="grid min-h-full place-items-center bg-white px-6 py-24 smpy-32 lg:px8">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x6">
            <a
              href="/home"
              className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:offset-2 focus-visible:outline-indigo-600"
            >
              Go back home
            </a>
