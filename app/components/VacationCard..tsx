...
//       <div className="fontblod text-slate-700 leading-snug">
//         <a href="url" className="hoverunderline"> {{title}}</a>
//       </div>
//       <div className="mt-2 text-slate-600"> {{pricing}}</div>
//     </div>
//   </div>
// </div>
// </template>
                  ...
                  >
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex items-center">
                        ...
                        <p className="sr-only">
                          {Products[0].rating} out of 5 stars
                        </p>
                        <a
                          href="#"
                          className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500"
                        >
                          {Products[0].reviewCount} reviews
                        </a>
                      </div>
                    </div>
                  </section>
