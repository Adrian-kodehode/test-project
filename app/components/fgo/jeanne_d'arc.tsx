  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/ruler/jeanne_darc/S059_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/ruler/jeanne_darc/S059_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/ruler/jeanne_darc/S059_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/ruler/jeanne_darc/S059_Stage4.png",
    },
  ];
  ...
  const costumes = [
    {
      id: 1,
      label: "Costume 1",
      src: "/Fgo/characters/ruler/jeanne_darc/S059_Costume1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/ruler/jeanne_darc/S059_Sprite_Ver3_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/ruler/jeanne_darc/S059_Sprite_Ver3_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/ruler/jeanne_darc/S059_Sprite_Ver3_Stage3.png",
    },
  ];
  ...
  const costumesSprite = [
    {
      ...
      src: "Fgo/characters/ruler/jeanne_darc/S059_Sprite_Ver3_Costume1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/ruler/jeanne_darc/S059_Stage1.png"
  );
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="text-white">
                <strong>Holy Maiden of Salvation</strong> (救国の聖女, Kyūkoku
                no Seijo?) Jeanne, Joan of Arc, Juana de Arco, La Pucelle
                d'Orléans, The Maiden of Orleans, St. Joan, Joanna d'arc,
                Johanna von Orléans
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-white">1,482/9,593</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">HP:</p>
              <p className="text-white">2,420/16,500</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">10,501</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">18,076</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">12,326</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">21,244</p>
            </div>
