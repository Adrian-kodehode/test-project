...
export const OkitaSojiSaberAlter = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/saber/okita_soji _alter/S317_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/saber/okita_soji _alter/S317_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/saber/okita_soji _alter/S317_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/saber/okita_soji _alter/S317_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/saber/okita_soji _alter/S317_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/saber/okita_soji _alter/S317_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/saber/okita_soji _alter/S317_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "Fgo/characters/saber/okita_soji _alter/S317_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 mb-2 mt-2">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Okita Sōji (Saber Alter). For other variations, see{" "}
      ...
      <div className="flex flex-col lg:flex-row gap-6 p-4 sm:p-6">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="text-white">
                (煉獄), Majin - Okita Sōji, Okita Souji Alter (Saber), Majin
                Saber
              </p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">ID:</p>
              <p className="text-white">317</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,826/12,465</p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">HP:</p>
              <p className="text-white">1,999/13,635</p>
            </div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">14,938</p>
            </div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">17,556</p>
            </div>
          ...
          <div>
            ...
            <span className="font-bold ml-2">┗ Stage 1-2:</span> <span className="text-blue-400">Group Servant</span>
          </div>
