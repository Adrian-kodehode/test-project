...
export const MysteriousExecutorCIEL = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Stage4.png",
    },
  ];
  ...
  const costumes = [
    {
      id: 1,
      label: "Costume 1",
      src: "/Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Costume1.png",
    },
    {
      id: 2,
      label: "Costume 2",
      src: "/Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Costume2.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Sprite_Ver1_Stage3.png",
    },
  ];
  ...
  const costumesSprite = [
    {
      ...
      src: "Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Sprite_Ver1_Costume1.png",
    },
    {
      id: 2,
      label: "Costume 2 Sprite",
      src: "Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Sprite_Ver1_Costume2.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/moon_cancer/mysterious_executor_c_i_e_l/S418_Stage1.png"
  );
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      {/* Main Tabs */}
      <div className="flex border-b border-gray-700 overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 mt-3">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">謎の代行者C.I.E.L; 教えて！シエル先生; スターシエル</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                C.I.E.L, Teach Me! Miss Ciel, Ciel, Star Ciel
              </p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">ID:</p>
              <p className="text-white">418</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">Semi Reverse S to Linear</p>
            </div>
