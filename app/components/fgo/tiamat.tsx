  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/beast/tiamat/S149_Stage1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/beast/tiamat/S149_Sprite_Ver1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/beast/tiamat/S149_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-white italic text-center sm:text-left">
          ...
          />
          Femme Fatale form Tiamat. For
          <img
            src="Fgo/characters/beast/Class-Beast (1).png"
            alt=""
            className="inline-block h-8 w-8 ml-1 mr-1"
          />
          Draconic Body form, see{" "}
          <a href="" className="text-blue-400">
            Tiamat (Draconic Body)
          </a>
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">ティアマト</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                <strong>Femme Fatale</strong> (ファム・ファタール), Beast II,
                Goddess of Beginning, Nammu, Mother of Genesis
              </p>
            </div>
            <div>
              <p className="text-white mb-1">ID:</p>
              <p className="text-white">149</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">2,101/13,596</p>
            </div>
            <div>
              <p className="text-white mb-1">HP:</p>
              <p className="text-white">2,745/18,720</p>
            </div>
