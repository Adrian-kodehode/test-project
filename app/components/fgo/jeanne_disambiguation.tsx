    ...
    const mockData = [
      {
        rarity: "5★",
        href: "jeanne_d'arc",
        icon: "Fgo/characters/jeanne_disambiguation/S059A1Icon.png",
        servant: "Jeanne d'Arc",
        description:
          "The original Jeanne d'Arc from Fate/Apocrypha.",
      },
      {
        rarity: "5★",
        href: "jeanne_d'arc_alter",
        icon: "Fgo/characters/jeanne_disambiguation/S106A1Icon.png",
        servant: "Jeanne d'Arc (Alter)",
        description:
          "The altered version of Jeanne d'Arc first appearing in the Da Vinci and The 7 Counterfeit Heroic Spirits event as an Avenger.",
      },
      {
        rarity: "4★",
        href: "",
        icon: "Fgo/characters/jeanne_disambiguation/S141A1Icon.png",
        servant: "Jeanne d'Arc Alter Santa Lily",
        description:
          "The Lily and Santa version of Jeanne d'Arc (Alter) appearing in Christmas 2016 as an event limited free 4★ Lancer.",
      },
      {
        rarity: "5★",
        href: "jeanne_d'arc_archer",
        icon: "Fgo/characters/jeanne_disambiguation/S216A1Icon.png",
        servant: "Jeanne d'Arc (Archer)",
        description:
          "The Archer-version of Jeanne d'Arc, appearing in the Servant Summer Festival! 2018 storyline.",
      },
      {
        rarity: "4★",
        href: "jeanne_d'arc_berserker_alter",
        icon: "Fgo/characters/jeanne_disambiguation/S219A1Icon.png",
        servant: "Jeanne d'Arc (Berserker Alter)",
        description:
      ...
      {
        rarity: "4★",
        href: "metatron_jeanne",
        icon: "Fgo/characters/jeanne_disambiguation/S438A1Icon.png",
        servant: "Metatron Jeanne",
        description:
          "The Another Ruler-version of Jeanne d'Arc, appearing in the Trinity Metatronius storyline.",
      },
      {
        rarity: "5★",
        href: "",
        icon: "Fgo/characters/jeanne_disambiguation/Jeanne_d'Arc_(Ruler_Alter)_(Enemy)Icon.png",
        servant: "Jeanne d'Arc (Ruler Alter)",
        description:
          "The altered version of Jeanne d'Arc appearing in the storyline of Orleans as a Ruler. She is an Enemy-only Servant and cannot be summoned.",
      },
      {
        rarity: "5★",
        href: "artoria_pendragon_archer",
        icon: "Fgo/characters/jeanne_disambiguation/Jeanne_d'Arc_(Lancer)_(Enemy)Icon.png",
        servant: "Jeanne d'Arc (Lancer)",
        description:
          "The Lancer version of Jeanne d'Arc from Fate/Samurai Remnant. She is an Enemy-only Servant and cannot be summoned.",
      },
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 font-sans p-4 md:p-8">
      ...
      <main className="bg-gray-800 p-4 md:p-8 rounded-lg shadow-lg">
        ...
        <div className="bg-blue-900 p-4 rounded-lg border-l-4 border-blue-500 mb-6 text-sm md:text-base">
          <strong>
            This article is a disambiguation page for Jeanne (Disambiguation){" "}
          </strong>
          ...
          <br />
          <br />
          <strong>Jeanne d'Arc</strong> is one of the Ruler-class Servants who
          first appeared in Fate/Apocrypha. Below are the variations of Jeanne
          that have appeared in FGO:
        </div>
