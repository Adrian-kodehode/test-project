...
export const BB_Dubai = () => {
  const [activeTab, setActiveTab] = useState("servant");
  const [activeStage, setActiveStage] = useState(1);

  const tabs = ["Servant", "Dialogue", "Quest", "Gallery"];
  const stages = [
    { id: 1, label: "Stage 1", src: "/Fgo/characters/BB/S421_Stage1.png" },
    { id: 2, label: "Stage 2", src: "/Fgo/characters/BB/S421_Stage2.png" },
    { id: 3, label: "Stage 3", src: "/Fgo/characters/BB/S421_Stage3.png" },
    { id: 4, label: "Stage 4", src: "/Fgo/characters/BB/S421_Stage4.png" },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/BB/S421_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/BB/S421_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/BB/S421_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/BB/S421_Stage1.png"
  );
      ...
      <div className="flex gap-6 p-6">
        ...
        <div className="w-1/2 space-y-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            />
            <div>
              <h1 className="text-4xl font-bold text-white">BB Dubai</h1>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">ＢＢドバイ; ＢＢコスモ; ゴールデンＢＢ</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,661/10,753</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">HP:</p>
              <p className="text-white">2,286/11,506</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">11,771</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">17,082</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">13,817</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">20,076</p>
            </div>
            ...
            <div>
              ...
              <p className="text-green-400">Star</p>
            </div>
            <div>
          ...
          <div>
            ...
            <h2 className="mt-2">┗ Stage 2 <span className="text-blue-400">Levitating Servant</span>, <span className="text-blue-400">Spaceflight-able Servant</span></h2>
            <h2 className="mt-2">┗ Stage 3 <span className="text-blue-400">Animal Characteristics Servant</span>, <span className="text-blue-400">Bunny Servant</span></h2>
