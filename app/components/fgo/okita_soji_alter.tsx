  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/alter_ego/okita_soji_alter/S209_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/alter_ego/okita_soji_alter/S209_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/alter_ego/okita_soji_alter/S209_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/alter_ego/okita_soji_alter/S209_Stage4.png",
    },
  ];
  ...
  const costumes = [
    {
      id: 1,
      label: "Costume 1",
      src: "/Fgo/characters/alter_ego/okita_soji_alter/S209_Costume1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/alter_ego/okita_soji_alter/S209_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/alter_ego/okita_soji_alter/S209_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/alter_ego/okita_soji_alter/S209_Sprite_Ver1_Stage3.png",
    },
  ];
  ...
  const costumesSprite = [
    {
      ...
      src: "Fgo/characters/alter_ego/okita_soji_alter/S209_Sprite_Ver1_Costume1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/alter_ego/okita_soji_alter/S209_Stage1.png"
  );
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">沖田総司〔オルタ〕; 魔人神・沖田総司</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-white mb-1">AKA:</p>
              <p className="text-white">
                <strong>Majin Saber</strong> (魔人神セイバー?), Okita Souji
                (Alter), Majin - Okita Sōji,{" "}
                <strong>Majin Okita Sōji Alternative</strong>
                (魔人神・沖田総司オルタナティブ?),{" "}
                <strong>Rengoku Alter</strong> (煉獄オルタ?)
              </p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">ID:</p>
              <p className="text-white">209</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,926/12,465</p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">HP:</p>
              <p className="text-white">1,862/12,696</p>
            </div>

            <div>
              <p className="text-yellow-400 font-bold">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">13,645</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">16,016</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-blue-400">Yūki Aoi, Nakamura Yūichi</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-white">Neutral • Balanced</p>
            </div>
            ...
            <div className="col-span-1 sm:col-span-2">
              <p className="text-white mb-1">
                ...
                <span className="text-blue-400">
                  Female <span className="text-white">(Stage 1 ~ 3)</span>
                </span>
              </p>
              <p>
                ┗{" "}
                <span className="text-blue-400">
                  Unknown <span className="text-white">(Costume 1)</span>
                </span>
              </p>
            </div>
          </div>
