...
export const ArtoriaPendragonAlter = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/saber/artoria_pendragon(alter)/S003_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/saber/artoria_pendragon(alter)/S003_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/saber/artoria_pendragon(alter)/S003_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/saber/artoria_pendragon(alter)/S003_Stage4.png",
    },
  ];
  ...
  const costumes = [
    {
      id: 1,
      label: "Costume 1",
      src: "/Fgo/characters/saber/artoria_pendragon(alter)/S003_Costume1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/saber/artoria_pendragon(alter)/S003_Sprite_Ver3_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/saber/artoria_pendragon(alter)/S003_Sprite_Ver3_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/saber/artoria_pendragon(alter)/S003_Sprite_Ver3_Stage3.png",
    },
  ];
  ...
  const costumesSprite = [
    {
      ...
      src: "Fgo/characters/saber/artoria_pendragon(alter)/S003_Sprite_Ver3_Costume1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/saber/artoria_pendragon(alter)/S003_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            <h3 className="text-lg font-bold text-white">
              This is a Story Locked Servant 🔒
            </h3>
          </div>
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          Artoria Pendragon (Alter). For the other variations, see{" "}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="text-white">
                 Saber Alter, Dark-Tainted Tyrant, Artoria Alter, Black Saber, Salter, Altria Pendragon (Alter)
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-white">1,708/10,248</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">HP:</p>
              <p className="text-white">1,854/11,589</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">12,408</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">14,051</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">14,569</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">16,514</p>
            </div>
