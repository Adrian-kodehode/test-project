  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/caster/kuonji_alice/S415_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/caster/kuonji_alice/S415_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/caster/kuonji_alice/S415_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/caster/kuonji_alice/S415_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/caster/kuonji_alice/S415_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/caster/kuonji_alice/S415_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/caster/kuonji_alice/S415_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "Fgo/characters/caster/kuonji_alice/S415_Stage1.png"
  );
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white"> 久遠寺有珠</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,645/10,650</p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">HP:</p>
              <p className="text-white">2,166/14,773</p>
            </div>

            <div>
              <p className="text-yellow-400 font-bold">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">11,658</p>
            </div>
            <div>
              <p className="text-yellow-400 font-bold">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">16,184</p>
            </div>

            <div>
              <p className="text-yellow-400 font-bold">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">13,684</p>
            </div>
            <div>
              <p className="text-yellow-400 font-bold">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">19,021</p>
            </div>

            <div>
              <p className="text-white mb-1 font-bold">Voice Actor:</p>
              <p className="text-blue-400">Kayano Ai</p>
            </div>

            <div>
              <p className="text-white mb-1 font-bold">Illustrator:</p>
              <p className="text-blue-400">Honjō Raita</p>
            </div>

            <div>
              <p className="text-white mb-1 font-bold">Attribute:</p>
              <div className="flex items-center gap-1">
                <p className="text-blue-400 mb-0">Man</p>
                <p className="mb-0">(Stage 1-2)</p>
              </div>
              <div className="flex items-center gap-1">
                <p>┗</p>
                <p className="text-blue-400 mb-0">Earth</p>
                <p className="mb-0">(Stage 3)</p>
              </div>
            </div>
            ...
            <div>
              ...
              <p>(Stage 1-2)</p>
              <div>
                <p>┗ <span className="text-blue-400">Chaotic • Evil</span> (Stage 3)</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div>
                <p className="ml-2">┗ Stage 3: <span className="text-blue-400">Levitating Servant</span></p>
            </div>
          </div>
