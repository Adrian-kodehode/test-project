    ...
    const mockData = [
      {
        rarity: "4★",
        href: "nero_claudius",
        icon: "Fgo/characters/nero_claudius_disambiguation/S005A1Icon.png",
        servant: "Nero Claudius",
        description: "The original Jeanne d'Arc from Fate/Apocrypha.",
      },
      {
        rarity: "5★",
        href: "nero_claudius_bride",
        icon: "Fgo/characters/nero_claudius_disambiguation/S090A1Icon.png",
        servant: "Nero Claudius (Bride)",
        description:
      ...
      {
        rarity: "5★",
        href: "nero_claudius_caster",
        icon: "Fgo/characters/nero_claudius_disambiguation/S175A1Icon.png",
        servant: "Nero Claudius (Caster)",
        description:
          "The Lily and Santa version of Jeanne d'Arc (Alter) appearing in Christmas 2016 as an event limited free 4★ Lancer.",
      },
      {
        rarity: "5★",
        href: "sodom's_beast_draco",
        icon: "Fgo/characters/nero_claudius_disambiguation/S377A1Icon (1).png",
        servant: "Sodom's Beast/Draco",
        description:
          "The Archer-version of Jeanne d'Arc, appearing in the Servant Summer Festival! 2018 storyline.",
      },
      {
        rarity: "5★",
        href: "beast_vi_s_arcade",
        icon: "Fgo/characters/nero_claudius_disambiguation/BeastVI-SArcadeIcon.png",
        servant: "Beast VI/S (Arcade)",
        description:
      ...
      },
      {
        ...
        icon: "Fgo/characters/nero_claudius_disambiguation/S377A2Icon.png",
        servant: "Sodom's Beast/Draco (Arcade)",
        description:
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 font-sans p-4 md:p-8">
      ...
      <main className="bg-gray-800 p-4 md:p-8 rounded-lg shadow-lg">
        ...
        <div className="bg-blue-900 p-4 rounded-lg border-l-4 border-blue-500 mb-6 text-sm md:text-base">
          <strong>
            This article is a disambiguation page for Nero Claudius
            (Disambiguation)
          </strong>
          ...
          <br />
          <br />
          Nero Claudius is one of the Saber-class Servants who first appeared in
          Fate/Extra. Below are the variations of Nero Claudius that have
          appeared in FGO:
        </div>
