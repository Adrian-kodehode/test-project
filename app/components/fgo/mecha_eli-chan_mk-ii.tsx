...
export const MechaEliChanMkII = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1-3",
      src: "/Fgo/characters/alter_ego/mecha_eli-chan_mk-ii/S191_Stage1.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/alter_ego/mecha_eli-chan_mk-ii/S191_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite",
      src: "Fgo/characters/alter_ego/mecha_eli-chan_mk-ii/S191_Sprite_Ver1_Stage1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/alter_ego/mecha_eli-chan_mk-ii/S191_Stage1.png"
  );
  ...
  const cardTypes = [
    { type: "quick, arts, buster", icon: "Fgo/QABBB.png" },
  ];
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 text-sm">
            ...
            time-limited event{" "}
            <span className="text-blue-400">Halloween 2017 Event</span>.
          </p>
          <p className="mt-3">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Mecha Eli-chan Mk.II. For other variations, see{" "}
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">メカエリチャンⅡ号機</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">Magus Aegis Elizabeth Channel II, MK.II</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">ID:</p>
              <p className="text-white">191</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,666/9,997</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">HP:</p>
              <p className="text-white">1,744/10,901</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">12,104</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">13,217</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">14,212</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">15,534</p>
            </div>
            ...
            <div>
              ...
              <p className="text-blue-400">Lawful • Good</p>
            </div>
