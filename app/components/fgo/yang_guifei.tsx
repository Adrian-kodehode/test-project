...
export const YangGuifei = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/foreigner/yang_guifei/S275_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/foreigner/yang_guifei/S275_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/foreigner/yang_guifei/S275_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/foreigner/yang_guifei/S275_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/foreigner/yang_guifei/S275_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/foreigner/yang_guifei/S275_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/foreigner/yang_guifei/S275_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/foreigner/yang_guifei/S275_Stage1.png"
  );
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      {/* Article Navigation */}
      <div className="px-0 sm:px-0 mb-2 mt-2"></div>
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">楊貴妃</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                <strong>Yang Yuhuan</strong> (楊玉環ヤン・ユーファン), Cthugha,
                Yōkihi, Yuyu, Taizhen
              </p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">ID:</p>
              <p className="text-white">275</p>
            </div>
            ...
            <div className="flex items-center gap-2 col-span-1">
              ...
              <span className="text-white">0.51%</span>
            </div>
            <div className="flex items-center gap-2 col-span-1">
              <img
