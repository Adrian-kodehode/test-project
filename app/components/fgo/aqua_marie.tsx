  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/beast/u-olga_marie/S412_Stage1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/beast/u-olga_marie/S412_Sprite_Ver1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/beast/u-olga_marie/S412_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-white italic text-center sm:text-left">
          This article is about the Enemy Beast Aqua Marie. For other
          variations, see
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">Ｅ－アクアマリー; アクアマリー</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                <strong>Nontidal LostbeltElement Aqua Marie</strong>
                (零潮遺分體れいちょういぶんたいアクアマリー)
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-blue-500">152 in CAN</p>
            </div>
            ...
            <div>
              ...
              <p className="text-blue-500">Neutral • Good</p>
            </div>
            <div>
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              <span className="text-blue-400">Olga Marie Quest_2</span>
            </p>
          </div>
        </div>
