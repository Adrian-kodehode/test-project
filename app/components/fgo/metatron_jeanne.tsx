  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/ruler/metatron_jeanne/S438_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/ruler/metatron_jeanne/S438_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/ruler/metatron_jeanne/S438_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/ruler/metatron_jeanne/S438_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/ruler/metatron_jeanne/S438_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/ruler/metatron_jeanne/S438_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/ruler/metatron_jeanne/S438_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "Fgo/characters/ruler/metatron_jeanne/S438_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 mb-2 mt-2">
        <p className="text-sm text-white italic text-center sm:text-left">
          ...
          />{" "}
          <span>Metatron Jeanne. For other variations, see </span>
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">13,085</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">15,360</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-blue-400">Konoe Ototsugu</p>
            </div>
