  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/lancer/elizabeth_bathory/S018_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/lancer/elizabeth_bathory/S018_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/lancer/elizabeth_bathory/S018_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/lancer/elizabeth_bathory/S018_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/lancer/elizabeth_bathory/S018_Sprite_Ver2_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/lancer/elizabeth_bathory/S018_Sprite_Ver2_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/lancer/elizabeth_bathory/S018_Sprite_Ver2_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/lancer/elizabeth_bathory/S018_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-white italic text-center sm:text-left">
          ...
          />
          Elizabeth Báthory. For other variations, see{" "}
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">エリザベート・バートリー</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                Elizabeth, Elisabeth Báthory, Elizabeth Bathory, Blood Countess,
                Countess Dracula, Eli-Chan
              </p>
            </div>
            <div>
              <p className="text-white mb-1">ID:</p>
              <p className="text-white">018</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,520/9,122</p>
            </div>
            <div>
              <p className="text-white mb-1">HP:</p>
              <p className="text-white">1,899/11,870</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">11,045</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">14,392</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">12,968</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">16,915</p>
            </div>

            <div>
              <p className="text-blue-400 mb-1">Voice Actor:</p>
              <p className="text-blue-500">Ōkubo Rumi</p>
            </div>
            <div>
