  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/foreigner/abigail_williams/S195_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/foreigner/abigail_williams/S195_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/foreigner/abigail_williams/S195_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/foreigner/abigail_williams/S195_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/foreigner/abigail_williams/S195_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/foreigner/abigail_williams/S195_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/foreigner/abigail_williams/S195_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/foreigner/abigail_williams/S195_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 mb-2 mt-2">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Abigail Williams. For the summer{" "}
          ...
          />
          , see{" "}
          <a href="/abigail_williams_summer" className="text-blue-400">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">アビゲイル・ウィリアムズ</p>
            </div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">15,086</p>
            </div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">17,730</p>
            </div>
