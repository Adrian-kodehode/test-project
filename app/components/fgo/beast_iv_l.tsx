  ...
  const stages = [
    {
      id: 1,
      label: "Saint Graph",
      src: "/Fgo/characters/beast/beast_iv_l/S333_Stage1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite",
      src: "Fgo/characters/beast/beast_iv_l/Beast_IV-L_Sprite_Ver1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/beast/beast_iv_l/S333_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-white italic text-center sm:text-left">
          ...
          />{" "}
          <span>Beast IV: L. For Beast Unknown Beast (Unknown), see </span>
          <a href="/beast_of_cherishment" className="text-blue-400">
            <span> Beast of Cherishment</span>
          </a>
          <span>
            {" "}
            . For 5<span className="text-yellow-500 text">★</span>{" "}
            <img
          ...
          <a href="/koyanskaya_of_darkness" className="text-blue-400">
            <span> Koyanskaya of Darkness</span>
          </a>
          .
        </p>
      </div>
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">
                Ｅ－ステラマリー; ビーストⅣ; ビーストⅣ: Ｌ
              </p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                <strong>Lostbelt:Beast IV</strong> (ロストベルト：ビーストⅣ?),
                Beast IV: Lost, Koyanskaya
              </p>
            </div>
            <div>
              <p className="text-white mb-1">ID:</p>
              <p className="text-white">443</p>
            </div>
            ...
            <div>
              ...
              <p className="text-blue-500">Saitō Chiwa</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-white mb-1 font-bold">Charges: 5</p>
            </div>
            <div>
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              <span className="text-blue-400">Olga Marie Quest_4</span>
            </p>
          </div>
        </div>
