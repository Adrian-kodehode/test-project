...
export const JeanneDArcBerserkerAlter = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/berserker/jeanne_darc_alter/S219_Stage1.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/berserker/jeanne_darc_alter/S219_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/berserker/jeanne_darc_alter/S219_Sprite_Ver1_Stage1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/berserker/jeanne_darc_alter/S219_Stage1.png"
  );
      ...
      <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 text-sm">
            ...
            time-limited event{" "}
            <span className="text-blue-400">Servant Summer Festival! 2018</span>
            .
          </p>
          <p className="mt-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="text-white">
                {" "}
                Jeanne Alter, Jeanne d'Arc Alter (Berserker), Summer Jalter
              </p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">ID:</p>
              <p className="text-white">219</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,716/10,298</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">HP:</p>
              <p className="text-white">1,862/9,922</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">12,469</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">15,640</p>
            </div>
            <div>
