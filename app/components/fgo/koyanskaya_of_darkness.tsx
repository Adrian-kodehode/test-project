...
export const KoyanskayaOfDarkness = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/foreigner/koyanskaya_of_darknress/S334_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/foreigner/koyanskaya_of_darknress/S334_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/foreigner/koyanskaya_of_darknress/S334_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/foreigner/koyanskaya_of_darknress/S334_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/foreigner/koyanskaya_of_darknress/S334_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/foreigner/koyanskaya_of_darknress/S334_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 mb-2 mt-2">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          see{" "}
          <a href="/koyanskaya_of_light" className="text-blue-400">
            Koyanskaya of Light
          </a>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="text-white">
                ...
                (ヤースカヤ), Koyanskaya of Dark
              </p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">ID:</p>
              <p className="text-white">334</p>
            </div>
