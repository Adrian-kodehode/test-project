...
export const KamaMara = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/beast/kama_mara/Kama-Mara_Portrait.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/beast/kama_mara/Kama-Mara_Sprite_Ver1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/beast/kama_mara/Kama-Mara_Portrait.png"
  );
  ...
  const traits = ["Demonic", "Divinity", "Humanoid", "King"];
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">カーマ／マーラ</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="text-white">
                ...
                ,{" "}
                <a href="/kama" className="text-blue-400">
                  Kama
                </a>
              </p>
            </div>
            <div>
              <span className="text-white mb-1">ID: -</span>
            </div>
            ...
            <div>
              ...
              <p className="text-blue-500">Shitaya Noriko</p>
            </div>
            <div>
              <p className="text-blue-400 mb-1">Illustrator:</p>
              <p className="text-blue-500">ReDrop</p>
            </div>
            ...
            <div>
              <p className="text-white mb-1 font-bold">Actions: 4</p>
            </div>
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              <span className="text-blue-400">
                Olga Marie Quest_Tokugawa Kaiten Meikyū - Ōoku, Strengthening
                Quest: Angra Mainyu
              </span>
            </p>
          </div>
