  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1-3",
      src: "/Fgo/characters/alter_ego/mecha_eli-chan/S190_Stage1.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/alter_ego/mecha_eli-chan/S190_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite",
      src: "Fgo/characters/alter_ego/mecha_eli-chan/S190_Sprite_Ver1_Stage1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/alter_ego/mecha_eli-chan/S190_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Mecha Eli-chan. For other variations, see{" "}
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">メカエリチャン</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">Magus Aegis Elizabeth Channel</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">ID:</p>
              <p className="text-white">190</p>
            </div>
