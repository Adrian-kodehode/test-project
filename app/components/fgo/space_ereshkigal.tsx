...
export const SpaceEreshkigal = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/beast/space_ereshkigal/S417_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/beast/space_ereshkigal/S417_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/beast/space_ereshkigal/S417_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/beast/space_ereshkigal/S417_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/beast/space_ereshkigal/S417_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/beast/space_ereshkigal/S417_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/beast/space_ereshkigal/S417_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/beast/space_ereshkigal/S417_Stage1.png"
  );
  ...
  const cardTypes = [{ type: "quick, arts, buster", icon: "Fgo/icons/QAABB.png" }];
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-white italic text-center sm:text-left">
          ...
          />
          Space Ereshkigal. For <span className="text-yellow-400">5★</span>{" "}
          <img
          ...
          />
          , see{" "}
          <a href="/ereshkigal" className="text-blue-400">
            Ereshkigal
          </a>
          . For enemy version, see{" "}
          <a href="/ereshkigal_enemy" className="text-blue-400">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">
                スペース・エレシュキガル; エレシュキガル; アンキ・エレシュキガル
              </p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                <strong>Ereshkigal, Anki Ereshkigal, Null Beast</strong>{" "}
                (無の獣)
              </p>
            </div>
            <div>
              <p className="text-white mb-1">ID:</p>
              <p className="text-white">417</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,766/11,427</p>
            </div>
            <div>
              <p className="text-white mb-1">HP:</p>
              <p className="text-white">2,131/14,530</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">12,509</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">15,918</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">14,682</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">18,708</p>
            </div>

            <div>
              <p className="text-blue-400 mb-1">Voice Actor:</p>
              <p className="text-blue-500">Ueda Kana</p>
            </div>
            <div>
              <p className="text-blue-400 mb-1">Illustrator:</p>
              <p className="text-blue-500">Morii Shizuki</p>
            </div>
          ...
          <div>
            ...
            <p className="mt-2 ml-2">
              ...
              <span className="text-blue-400">Hominidae Servant, Summer Mode Servant</span>
            </p>
             <p className="mt-2 ml-2">
              <strong>┗ Stage 2-3</strong>:{" "}
              <span className="text-blue-400">Levitating Servant, Non-Hominidae Servant, Super Large</span>
            </p>
          </div>
