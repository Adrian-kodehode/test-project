  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/alter_ego/meltryllis/S163_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/alter_ego/meltryllis/S163_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/alter_ego/meltryllis/S163_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/alter_ego/meltryllis/S163_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/alter_ego/meltryllis/S163_Sprite_Ver2_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/alter_ego/meltryllis/S163_Sprite_Ver2_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/alter_ego/meltryllis/S163_Sprite_Ver2_Stage3.png",
    },
  ];


  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/alter_ego/meltryllis/S163_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 mb-2 mt-2">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Meltryllis. For <span className="text-yellow-400">5★</span> <img
            src="Fgo/characters/lancer/Class-Lancer-Gold (1).png"
            alt=""
            className="inline-block h-8 w-8 ml-1"
          />{" "}, see{" "}
          <a href="mysterious_alter_ego" className="text-blue-400">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">メルトリリス</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                Meltlilith, Alter Ego S, Artemis, Lotan, Sarasvati
              </p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">ID:</p>
              <p className="text-white">163</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,807/11,692</p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">HP:</p>
              <p className="text-white">1,965/13,402</p>
            </div>

            <div>
              <p className="text-yellow-400 font-bold">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">12,799</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">15,023</p>
            </div>
            <div>
              <p className="text-yellow-400 font-bold">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">17,256</p>
            </div>
