...
export const KatsushikaHokusaiSaber = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1-3",
      src: "/Fgo/characters/saber/Katsushika Hokusai (Saber)/S264_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 4",
      src: "/Fgo/characters/saber/Katsushika Hokusai (Saber)/S264_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/saber/Katsushika Hokusai (Saber)/S264_Sprite_Ver1_Stage1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/saber/Katsushika Hokusai (Saber)/S264_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 text-sm">
            ...
            <img
              src="/Fgo/characters/saber/Katsushika Hokusai (Saber)/SpiritTourLeaf.png"
              alt=""
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Kastsushika Hokusai. For <span className="text-yellow-400">5★</span>{" "}
          <img
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="text-white">
                ...
                Daughter); Tokitarō, Dragon-Crested Octopus, Darusen,{" "}
                <strong>The Old Man Mad About Art Manji</strong>
                (画狂老人卍, Gakyō Rōjin Manji?, Last renamed name)
              </p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">ID:</p>
              <p className="text-white">264</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,564/9,389</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">HP:</p>
              <p className="text-white">1,899/11,873</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">11,368</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">14,396</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">13,348</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">16,919</p>
            </div>
            ...
            <div className="flex items-center gap-2 col-span-1">
              ...
              <span className="text-white">28.8%</span>
            </div>
            <div>
