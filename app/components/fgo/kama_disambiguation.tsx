    ...
    const mockData = [
      {
        rarity: "5★",
        href: "kama",
        icon: "Fgo/characters/kama_disambiguation/S239A1Icon.png",
        servant: "Kama",
        description:
          "The original Kama, first appearing in Tokugawa Kaiten Meikyū - Ōoku event storyline.",
      },
      {
        rarity: "5★",
        href: "kama_avenger",
        icon: "Fgo/characters/kama_disambiguation/S321A1Icon (1).png",
        servant: "Kama (Avenger)",
        description:
          "The Avenger-version of Kama, first appearing in Chaldea Summer Adventure event storyline.",
      },
      {
        rarity: "N/A",
        href: "kama_mara",
        icon: "Fgo/characters/kama_disambiguation/Kama-MaraIcon.png",
        servant: "Kama/Mara",
        description:
          "The Mara version of Kama, first appearing in Tokugawa Kaiten Meikyū - Ōoku event storyline.",
      },
      {
        rarity: "5★",
        href: "beast_iii_l",
        icon: "Fgo/characters/kama_disambiguation/S240A1Icon.png",
        servant: "Beast III/L",
        description:
          "The Beast III/L version of Kama, first appearing in Tokugawa Kaiten Meikyū - Ōoku event storyline.",
      },
      {
        rarity: "5★",
        href: "kama_mistake_arcade",
        icon: "Fgo/characters/kama_disambiguation/KamaMistakeArcadeA1Icon.png",
        servant: "Kama (Mistake) (Arcade)",
        description:
          "The Arcade-exclusive Archer version of Kama from Fate/Grand Order Arcade.",
      },
    ];
    setData(mockData);
  }, []);
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 font-sans p-4 md:p-8">
      ...
      <main className="bg-gray-800 p-4 md:p-8 rounded-lg shadow-lg">
        ...
        <div className="bg-blue-900 p-4 rounded-lg border-l-4 border-blue-500 mb-6 text-sm md:text-base">
          <strong>
            {" "}
            This article is a disambiguation page for Kama (Disambiguation)
          </strong>
          ...
          <br />
          <br />
         <strong>Kama</strong> is one of the Assassin-class Servants who first appeared in Fate/Grand Order. Below are the variations of Kama that have appeared in FGO:
        </div>
