  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/alter_ego/tiamat/S376_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/alter_ego/tiamat/S376_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/alter_ego/tiamat/S376_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/alter_ego/tiamat/S376_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/alter_ego/tiamat/S376_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/alter_ego/tiamat/S376_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/alter_ego/tiamat/S376_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/alter_ego/tiamat/S376_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 mb-2 mt-2">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />
          , see{" "}
          <a href="/larva_tiamat_archer" className="text-blue-400">
            Larva/Tiamat (Archer)
          </a>
          ...
          <div>
            ...
            <div>
              <p className="font-bold ml-2 mt-2">
                ┗ Stage 1<span className="font-normal">-</span>2:{" "}
