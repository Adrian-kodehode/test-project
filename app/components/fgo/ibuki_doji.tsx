  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/saber/ibuki/S299_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/saber/ibuki/S299_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/saber/ibuki/S299_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/saber/ibuki/S299_Stage4.png",
    },
  ];
  ...
  const costumes = [
    {
      id: 1,
      label: "Costume 1",
      src: "/Fgo/characters/saber/ibuki/S299_Costume1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/saber/ibuki/S299_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/saber/ibuki/S299_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/saber/ibuki/S299_Sprite_Ver1_Stage3.png",
    },
  ];
  ...
  const costumesSprite = [
    {
      ...
      src: "Fgo/characters/saber/ibuki/S299_Sprite_Ver1_Costume1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/saber/ibuki/S299_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 mb-2 mt-2">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Ibuki Dōji. For <span className="text-yellow-400">5★</span>{" "}
          <img
          ...
          />
          , see{" "}
          <a href="/ibuki_doji_berserker" className="text-blue-400">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">伊吹童子</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">span, Ibuki-Douji</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-white">1,964/12,709</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">HP:</p>
              <p className="text-white">1,979/14,498</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">13,912</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">14,788</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">16,330</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">17,379</p>
            </div>
