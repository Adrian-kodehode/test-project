...
export const ElizabethBathoryCinderella = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1-3",
      src: "/Fgo/characters/rider/elizabeth_bathory_cinderella/S326_Stage1.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/rider/elizabeth_bathory_cinderella/S326_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite",
      src: "Fgo/characters/rider/elizabeth_bathory_cinderella/S326_Sprite_Ver1_Stage1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/rider/elizabeth_bathory_cinderella/S326_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-300 text-sm">
            ...
            time-limited event{" "}
            <span className="text-blue-400">Halloween 2021 Event</span>.
          </p>
          <p className="mt-3">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Elizabeth Bathory (Cinderella). For other variations, see{" "}
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">エリザベート・バートリー〔シンデレラ〕</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
               Elizabeth, Elisabeth Báthory (Cinderella)
              </p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">ID:</p>
              <p className="text-white">326</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white">1,527/9,166</p>
            </div>
            <div>
              <p className="text-gray-400 mb-1">HP:</p>
              <p className="text-white">1,769/11,058</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">11,098</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.100 Grail HP:</p>
              <p className="text-yellow-400 font-bold">13,408</p>
            </div>

            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail ATK:</p>
              <p className="text-yellow-400 font-bold">13,031</p>
            </div>
            <div>
              <p className="text-yellow-400 text-xs">Lv.120 Grail HP:</p>
              <p className="text-yellow-400 font-bold">15,029</p>
            </div>
            ...
            <div>
              ...
              <p className="text-blue-400">Chaotic • Balanced</p>
            </div>
