  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/ruler/melusine/S390_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/ruler/melusine/S390_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/ruler/melusine/S390_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/ruler/melusine/S390_Stage4.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/ruler/melusine/S390_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/ruler/melusine/S390_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/ruler/melusine/S390_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "Fgo/characters/ruler/melusine/S390_Stage1.png"
  );
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-white">1,776/11,495</p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">HP:</p>
              <p className="text-white">1,980/13,500</p>
            </div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">14,790</p>
            </div>
            ...
            <div>
              ...
              <p className="text-yellow-400 font-bold">17,382</p>
            </div>
          ...
          <div>
            ...
            <div className="ml-2 mt-2">
              <p>
                ┗ Stage 3{" "}
                <span className="text-blue-400">Levitating Serrvant</span>
              </p>
            </div>
          </div>
