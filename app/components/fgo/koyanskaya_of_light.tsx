...
export const KoyanskayaOfLight = () => {
  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/assassin/koyanskaya_of_light/S314_Stage1.png",
    },
    {
      id: 2,
      label: "Stage 2",
      src: "/Fgo/characters/assassin/koyanskaya_of_light/S314_Stage2.png",
    },
    {
      id: 3,
      label: "Stage 3",
      src: "/Fgo/characters/assassin/koyanskaya_of_light/S314_Stage3.png",
    },
    {
      id: 4,
      label: "Stage 4",
      src: "/Fgo/characters/assassin/koyanskaya_of_light/S314_Stage4.png",
    },
  ];
  ...
  const costumes = [
    {
      id: 1,
      label: "Costume 1",
      src: "/Fgo/characters/assassin/koyanskaya_of_light/S314_Costume1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/assassin/koyanskaya_of_light/S314_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/assassin/koyanskaya_of_light/S314_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/assassin/koyanskaya_of_light/S314_Sprite_Ver1_Stage3.png",
    },
  ];
  ...
  const costumesSprite = [
    {
      ...
      src: "Fgo/characters/assassin/koyanskaya_of_light/S314_Sprite_Ver1_Costume1.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/assassin/koyanskaya_of_light/S314_Stage1.png"
  );
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans px-4 sm:px-6 lg:px-8">
      ...
      <div className="px-0 sm:px-0 mb-2 mt-2">
        <p className="text-sm text-gray-400 italic text-center sm:text-left">
          ...
          />{" "}
          Koyanskaya of Light. For <span className="text-yellow-400">5★</span>
          <img
          ...
          />{" "}
          see{" "}
          <a href="/koyanskaya_of_darkness" className="text-blue-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="text-white">
                <strong>Tamamo Vitch Koyanskaya</strong>{" "}
                (タマモヴィッチ・コヤンスカヤ?),{" "}
                <span className="text-blue-400">Beast of Cherishment</span>,{" "}
                <span className="text-blue-400">Beast IV: L</span>, Yaskaya
                (ヤースカヤ)
              </p>
            </div>
            <div>
            ...
            <div className="flex items-center gap-2 col-span-1">
              ...
              <span className="text-white">0.76%</span>
            </div>
            <div className="flex items-center gap-2 col-span-1">
              <img
