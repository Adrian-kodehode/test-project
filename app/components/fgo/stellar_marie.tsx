  ...
  const stages = [
    {
      id: 1,
      label: "Stage 1",
      src: "/Fgo/characters/beast/u-olga_marie/S443_Stage1.png",
    },
  ];
  ...
  const sprites = [
    {
      id: 1,
      label: "Sprite 1",
      src: "Fgo/characters/beast/u-olga_marie/S443_Sprite_Ver1_Stage1.png",
    },
    {
      id: 2,
      label: "Sprite 2",
      src: "Fgo/characters/beast/u-olga_marie/S443_Sprite_Ver1_Stage2.png",
    },
    {
      id: 3,
      label: "Sprite 3",
      src: "Fgo/characters/beast/u-olga_marie/S443_Sprite_Ver1_Stage3.png",
    },
  ];

  const [activeImage, setActiveImage] = useState(
    "/Fgo/characters/beast/u-olga_marie/S443_Stage1.png"
  );
  ...
  <div className="bg-gray-800 border border-gray-600 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
      ...
      <div className="px-0 sm:px-0 my-4">
        <p className="text-sm text-white italic text-center sm:text-left">
          This article is about the Enemy Stellar Marie. For other variations,
          see
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-white">Ｅ－ステラマリー; ステラマリー</p>
            </div>
            <div className="col-span-1 sm:col-span-2">
              <p className="text-gray-400 mb-1">AKA:</p>
              <p className="text-white">
                <strong>Starbale LostbeltElement Stella Marie</strong>{" "}
                (星禍遺分體せいかいぶんたいステラマリー?)
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-blue-500">Hagiya Kaoru</p>
            </div>
            ...
            <div>
              ...
              <p className="text-blue-500">Lawful • Evil</p>
            </div>
            <div>
              <p className="text-white mb-1 font-bold">Charges: 3</p>
            </div>
            <div>
