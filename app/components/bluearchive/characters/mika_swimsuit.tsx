...
const Mika_SwimsuitLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/characters/Mika_Swimsuit_Icon_2.png"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const Mika_SwimsuitEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Mika_Swimsuit_EX.gif"
      alt="Mika_Swimsuit EX Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));

export const Mika_Swimsuit = () => {
      ...
      <main className="flex-1 mt-10 mb-10 w-[1300px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#fbb35a] w-[460px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-20 right-20 rounded">
              <span className="block text-center w-full italic">
                “ Sorry to keep you waiting, Sensei. Hehe, what do you think? ”
              </span>
              <br />
              <span className="absolute right-20 bottom-1 text-xs italic">
                ~ Misono Mika (Swimsuit ver.){" "}
              </span>
            </div>
            <p className="mt-5 max-w-[600px]">
              <strong>Misono Mika (Swimsuit ver.) (聖園ミカ (水着 Ver.))</strong> is the Swimsuit Variant of <a href="/mika" className="text-[#357ff3]">Mika</a> and is one of the{" "}
            ...
            <div className="ml-3 mt-2">
              <p>
             Mika-san, who led this vacation plan♪ She’s working hard to ensure her friends enjoy the beach, but she seems to be spinning her wheels a bit. Frustrated that the plans aren’t quite coming together, she’s been a little sleep-deprived lately...
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
            ...
            <div className="ml-3 mt-2">
              <p>
               See <span className="text-[#357ff3]">Misono Mika</span>
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Mika_Swimsuit_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Mika_Swimsuit_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Mika_Swimsuit_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Mika_Halo.png"
                          : "/Blue-Archive/characters/Mika_Swimsuit_Icon.png"
                      }
                      alt={`Hikari ${
                  ...
                  <tr>
                    ...
                    <td className="bg-[#f7e69a] px-2 py-2  text-center align-middle w-1/3">
                      <div className="flex gap-1 justify-center items-center w-full">
                        ...
                        />
                        <img
                          src="/Blue-Archive/icons/Blue_Font_8.png"
                          alt="Bond Level"
                          width={16}
                          height={16}
                          className="inline-block"
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">2177</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#fbb35a]">
                        ATK
                      </span>
                      <span className="font-bold text-lg text-black">385</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#fbb35a]">
                        DEF
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">1691</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">30173</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3850</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">102</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5074</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">32598</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4291</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">102</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5592</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">36369</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4828</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">102</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">6240</span>
                    </div>
                  </div>
                  {/* Profile Dropdown */}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              31.5, 33.1, 34.6, 40.9, 42.5, 44.1, 50.4, 52,
                              53.5, 59.8,
                            ].map((dmg, idx) => {
                              return (
                                <li key={idx}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              25.92, 27.22, 28.52, 33.7, 35, 36.29, 41.48, 42.77, 44.07, 49.25,
                            ].map((bar, i) => (
                              <li key={i}>
                                <span className="font-bold">
                                  LV{(i + 1).toString().padStart(2, "0")}
                                </span>{" "}
                                ~ Changes all attacks to  guaranteed CRIT. Increases Sonic Effectiveness by{" "}
                                <span className="text-[#fbb35a] font-bold">
                                  {bar}%
                                </span>{" "}
                  ...
                  <tbody>
                    <tr>
                      <td className="border-2 border-[#fbb35a] p-2 ">
                        <img
                          src="Blue-Archive/icons/Special_-_Form_Change.png"
                          alt="Cross Icon"
                      ...
                      <td className="border-2 border-[#fbb35a] p-2 flex flex-row items-center justify-center">
                        <img
                          src="Blue-Archive/icons/Buff_-_RANGE.png"
                          alt="Range Buff Icon"
                          className="w-9 h-10 mx-1"
                        />
                        <img
