...
const MoeLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Moe_Live2D.gif"
      alt="Moe Live2D"
...
const MoeEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Moe_EX.gif"
      alt="Moe EX Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#90abc9] w-[350px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-20 right-20 rounded">
              ...
              <span className="absolute right-20 bottom-1 text-xs italic">
                ~ Kazekura Moe <a href="#" className="text-[#357ff3]"></a>
              </span>
            </div>
            <p className="mt-5 max-w-[600px]">
              <strong>Kazekura Moe (霞沢ミユ) </strong>is one of the{" "}
                    ...
                    <img
                      src={
                        selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Moe_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Moe_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Moe_Halo.png"
                          : selectedTab === "gym"
                          ? "/Blue-Archive/characters/Moe_Gym_Portrait.png"
                          : selectedTab === "default" ||
                            selectedTab === "Default"
                          ? "/Blue-Archive/characters/Moe_Portrait.png"
                          : "/Blue-Archive/characters/Moe_Icon.png"
                      }
                      alt={`Moe ${
