...
const Hasumi_SwimsuitLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/characters/Hasumi_Swimsuit_Icon_2.png"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const Hasumi_SwimsuitEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Hasumi_Swimsuit_EX.gif"
      alt="Hasumi_Swimsuit EX Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));

export const Hasumi_Swimsuit = () => {
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#fbb35a] w-[400px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-20 right-20 rounded">
              <span className="block text-center w-full italic">
                “ Tch, is this a bit too cute for me...perhaps? ”
              </span>
              <br />
            ...
            <p className="mt-5 max-w-[600px]">
              <strong>Hanekawa Hasumi (Swimsuit ver.)</strong> (羽川ハスミ (水着 Ver.) is the
              Swimsuit Variant of <a href="" className="text-[#357ff3]">Hasumi</a> and is one of the <a href="" className="text-[#357ff3]">students</a> studying in
              <a href="" className="text-[#357ff3]">Trinity General School</a> who wields a <a href="" className="text-[#357ff3]">Sniper Rifle</a>.
            </p>
            <p className="mt-5">
            ...
            <div className="ml-3 mt-2">
              <p>
               Hasumi-san, who visited the beach as an escort for the <a href="#" className="text-[#357ff3]">Tea Party</a>. While she keeps her public and private life distinctly separate and doesn’t show it on her face, she seems genuinely delighted to be at the sea like this. Thanks to her tireless efforts, there should be no worries about her appearance in a swimsuit... or so she hopes?
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Hasumi_Swimsuit_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Hasumi_Swimsuit_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Hasumi_Swimsuit_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Hasumi_Halo.png"
                          : "/Blue-Archive/characters/Hasumi_Swimsuit_Icon.png"
                      }
                      alt={`Hikari ${
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">2394</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#fbb35a]">
                        ATK
                      </span>
                      <span className="font-bold text-lg text-black">447</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#fbb35a]">
                        DEF
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">1728</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">20754</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4471</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">114</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5182</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">22422</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4984</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">114</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5711</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">25016</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5606</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">114</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">6373</span>
                    </div>
                  </div>
                  {/* Profile Dropdown */}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              12.8, 13.5, 14.1, 15.7, 17.3, 18, 20.5, 21.2, 21.8, 24.4,
                            ].map((dmg, idx) => {
                              const stunDurations = [
                                4.7, 4.9, 5.1, 6.1, 6.3, 6.5, 7.5, 7.7, 8, 8.9,
                              ];
                              return (
                                <li key={idx}>
                                  ...
                                  ~ Increasses CRIT.R by{" "}
                                  <span className="text-[#fbb35a] font-bold">
                                    {dmg}%
                                  </span>{" "}
                                  then incresses CRIT.R by{" "}
                                  <span className="text-[#fbb35a] font-bold">
                                    {stunDurations[idx]}%
                                  </span>{" "}
                                  for every Cut Watermelon stack every{" "}
                                  <span className="text-[#fbb35a] font-bold">
                                    35
                                  </span>{" "}
                                  sec. ({" "}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              3.3, 3.4, 3.6, 4.2, 4.4, 4.6, 5.2, 5.4, 5.6, 6.2, 
                            ].map((bar, i) => (
                              <li key={i}>
                                <span className="font-bold">
                                  LV{(i + 1).toString().padStart(2, "0")}
                               ...
                               Cut Watermelon stack when using an EX-Skill and dealing DMG to an enemy{" "}
                                <span className="text-[#fbb35a] font-bold">
                                 4
                                </span>{" "}
                             times (
                                ...
                                <span className="text-[#fbb35a] font-bold">
                                    4
                                    </span>{" "} stacks). Increases CRIT.DMG by{" "}
                                <span className="text-[#fbb35a] font-bold">
                                     {bar}%
                                </span>{" "} for each Cut Watermelon stack.
                              </li>
                            ))}
                          </ul>
                        </td>
