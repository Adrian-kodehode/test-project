...
const AsunaBunnyLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Asuna_Bunny_Girl_Live2D.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const AsunaBunnyEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Asuna_Bunny_Girl_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Asuna_Bunny_Girl_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Asuna_Bunny_Girl_Sprite.png"
                          : selectedTab === "halo"
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">2387</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#4f86f7]">
                        ATK
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">1731</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">23868</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2487</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">113</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5195</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">25786</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2772</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">113</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5726</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">28769</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3119</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">113</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">6389</span>
                    </div>
                  </div>
                  {/* Profile Dropdown */}
