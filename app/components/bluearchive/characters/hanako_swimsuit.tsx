...
const Hanako_SwimsuitLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Hanako_Swimsuit_Live2D.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const Hanako_SwimsuitEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Hanako_Swimsuit_EX.gif"
      alt="Hanako_Swimsuit EX Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));

export const Hanako_Swimsuit = () => {
    ...
    >
      ...
      <main className="flex-1 mt-10 mb-10 w-[1300px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-1 mt-5 ml-3">
            ...
            <p className="mt-5 max-w-[600px]">
              <strong>Urawa Hanako (Swimsuit ver.)</strong> (浦和ハナコ
              (水着Ver.)) is the Swimsuit Variant of{" "}
            ...
            <div className="ml-3 mt-2">
              <p>
                Hanako in a swimsuit(?) visited an island. Her usual testing
                behavior seems to have faded away, and she seems to be opening
                up her heart...
              </p>
            </div>
            <h3
            ...
            <div className="ml-3 mt-2">
              <p>
                see{" "}
                <a href="/hanako" className="text-[#357ff3]">
                  Urawa Hanako
                </a>
              </p>
            </div>
            ...
            <div className="ml-3 mt-2">
              <p>
                Hanako has thigh-length pink hair that fades into a lighter
                tone. She sports a small braid on the right side, adorned with a
                white ribbon and has bangs that frame her face. Additionally,
                she has green eyes and a long ahoge atop her head.
              </p>
            </div>
            <h4
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Hanako_Swimsuit_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Hanako_(Swimsuit)_00.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Hanako_Swimsuit_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Hanako_Halo.png"
                          : "/Blue-Archive/characters/Hanako_Swimsuit_Icon.png"
                      }
                      alt={`Hikari ${
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">2513</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#fbb35a]">
                        ATK
                      </span>
                      <span className="font-bold text-lg text-black">370</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#fbb35a]">
                        DEF
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">1649</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">25122</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3701</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">119</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4948</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">27141</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4125</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">119</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5454</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">30281</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4641</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">119</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">6085</span>
                    </div>
                  </div>
                  {/* Profile Dropdown */}
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
              She wears a T-shirt over a pink bikini top. Although never
              actually seen normally without breaking the camera of the game,
              this article of clothing is the only thing she is wearing,
              preferring all natural exposure for her procreative regions, with
              nobody being any of the wiser along with her never making it
              obvious when teasing others.
            </p>
          </div>
          <h4
            className="text-[#3e7af2] text-lg font-bold ml-3 mt-4"
            ...
            <div className="mt-4 space-y-6">
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            <li>
                              ...
                              area. If the Water Gauge is at{" "}
                              <span className="text-[#fbb35a] font-bold">
                                1
                              </span>{" "}
                              or more, draws an EX-Skill and reduces the Water
                              Gauge by{" "}
                              <span className="text-[#fbb35a] font-bold">
                                1
                              </span>
              ...
              {activeSkillTab === "normal" && (
                <div className="overflow-x-auto">
                  <table className="w-[800px] border-2 border-[#fbb35a] rounded-lg">
                    <thead>
                      <tr>
                        <th
                          colSpan={2}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              118, 124, 130, 154, 160, 166, 190, 196, 201, 225,
                            ].map((dmg, idx) => {
                              const stunDurations = [
                                10.9, 11.4, 12, 14.1, 14.7, 15.2, 17.4, 18, 18.5, 20.7,
                              ];
                              return (
                                <li key={idx}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                             11.2, 11.4, 11.7, 12.8, 13.1, 13.4, 14.5, 14.8, 15.1, 16.2,
                            ].map((def, i) => (
                              <li key={i}>
                                <span className="font-bold">
                                  LV{(i + 1).toString().padStart(2, "0")}
                                </span>{" "}
                                ~ Increases ATK and CRIT.DMG by{" "}
                                <span className="text-[#fbb35a] font-bold">
                                  {def}%
                                </span>
                                .
                  ...
                  <table className="w-[800px] border-2 border-[#fbb35a] rounded-lg">
                    ...
                    <tbody>
                      <tr>
                        <td className="w-1/4 bg-[#fbb35a] p-2">
                          <img
                            src="Blue-Archive/icons/HANAKO_SWIMSUIT_SUB-SKILL.png"
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              20.1, 21.1, 22.1, 26.2, 27.2, 28.2, 32.2, 33.2, 34.2, 38.3
                            ].map((bar, i) => (
                              <li key={i}>
                                <span className="font-bold">
                                  LV{(i + 1).toString().padStart(2, "0")}
                                </span>{" "}
                                ~  When an ally other than the user uses an EX-Skill,
                                 charges the Water Gauge by{" "}
                                <span className="text-[#fbb35a] font-bold">
                                  40%
                                </span>.{" "}
                                 At{" "}
                              ...
                              (
                                ...
                                sec). The Water Gauge can be charged to{" "}(
                                <span className="text-[#fbb35a] font-bold">
                                  2
                                </span>).
                              </li>
                    ...
                    <tr>
                      ...
                      <td className="border-2 border-[#fbb35a]">
                        <div className="relative inline-block">
                          ...
                          <div>
                            <img
                              src="Blue-Archive/icons/Wolfsegg_0.png"
                              alt=""
                              className="w-12 h-10"
                            />
                          </div>
                    ...
                    <tr>
                      ...
                      <td className="border-2 border-[#fbb35a]">
                        <div className="relative inline-block">
                          ...
                          <div>
                            <img
                              src="Blue-Archive/icons/Wolfsegg_1.png"
                              alt=""
                              className="w-12 h-10"
                            />
                          </div>
                    ...
                    <tr>
                      ...
                      <td className="border-2 border-[#fbb35a]">
                        <div className="relative inline-block">
                          ...
                          <div>
                            <img
                              src="Blue-Archive/icons/Wolfsegg_2.png"
                              alt=""
                              className="w-12 h-10"
                            />
                          </div>
                    ...
                    <tr>
                      ...
                      <td className="border-2 border-[#fbb35a]">
                        <div className="relative inline-block">
                          ...
                          <div>
                            <img
                              src="Blue-Archive/icons/Wolfsegg_3.png"
                              alt=""
                              className="w-12 h-10"
                            />
                          </div>
