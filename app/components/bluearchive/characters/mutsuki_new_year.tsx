...
const MutsukiNewYearLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Mutsuki_New_Year_Live2D.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const MutsukiNewYearEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Mutsuki_New_Year_EX.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
      ...
      <main className="flex-1 mt-10 mb-10 w-[1300px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#e34a45] w-[400px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-40 rounded">
            ...
            <div className="ml-3 mt-2">
              <p>
                Mutsuki has changed her outfit for the New Year to go visit (and
                play) with the members of Handyman 68. She's a fast-paced,
                devilish girl who's enjoying the New Year while watching{" "}
                <a href="/aru" className="text-[#3e7af2] hover:underline">
                  Aru
                </a>
                , who's still in trouble as usual, sitting on a special seat
                nearby!
              </p>
            </div>
            <h3
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Mutsuki_New_Year_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Mutsuki_New_Year_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Mutsuki_New_Year_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Mutsuki_Halo.png"
                          : "/Blue-Archive/characters/Mutsuki_New_Year_Icon.png"
                      }
                      alt={`Hikari ${
              ...
              <table className="w-full border-separate border-spacing-y-2">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="bg-[#973333] px-2 py-2 text-center align-middle w-1/3">
                      <img
                        src="/Blue-Archive/weapons/MG_New_Icon.png"
                        alt="Handgun Icon"
                        width={80}
                        height={48}
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
              Mutsuki wears a white furisode adorned with greyish flower
              patterns, complemented by a dark pink obi featuring matching
              flower designs. Additionally, fluffy fur embellishes the collar of
              her furisode.
            </p>
          </div>
          <h4
                  ...
                  <table className="w-[800px] border-2 border-[#e34a45] rounded-lg">
                    ...
                    <tbody>
                      <tr>
                        <td className="w-1/4 bg-[#e34a45] p-2">
                          <img
                            src="Blue-Archive/icons/MUTSUKI_NEW_YEAR_SUB-SKILL.png"
          ...
          <div className="mt-10">
            ...
            <div className="flex w-full">
              ...
              <section className="mt-8 mb-8 overflow-x-auto">
                <table className="w-[1250px] border-separate border-spacing-y-2 border-2 border-[#e34a45] rounded-lg text-center">
                  <thead>
                    <tr>
