...
const Seia_SwimsuitLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/characters/Seia_Swimsuit_Icon_2.png"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const Seia_SwimsuitEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Seia_Swimsuit_EX.gif"
      alt="Seia_Swimsuit EX Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));

export const Seia_Swimsuit = () => {
