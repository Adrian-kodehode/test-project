...
const Miyu_SwimsuitLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Miyu_Swimsuit_Live2D.gif"
      alt="Miyu_Swimsuit Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const Miyu_SwimsuitEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Miyu_Swimsuit_EX.gif"
      alt="Miyu_Swimsuit EX Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));

export const Miyu_Swimsuit = () => {
    ...
    >
      ...
      <main className="flex-1 mt-10 mb-10 w-[1300px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-1 mt-5 ml-3">
            ...
            <p className="mt-5 max-w-[600px]">
              <strong>Kasumizawa Miyu (Swimsuit ver.) (霞沢ミユ) </strong> is
              the Swimsuit Variant of Miyu and is one of the{" "}
            ...
            <div className="ml-3 mt-2">
              <p>
                Miyu is in her swimsuit and goes fishing for undercover work.
                Sometimes she catches a big fish and attracts the attention of
                those around her... Her natural presence seems to be alive and
                well in this fishing village...
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
            ...
            <div className="ml-3 mt-2">
              <p>
                See{" "}
                <a href="/miyu#personality" className="text-[#357ff3]">
                  Kasumizawa Miyu
                </a>
              </p>
            </div>
            ...
            <div className="ml-3 mt-2">
              <p>
                Miyu (swimsuit) has long, black hair styled in two braids. She
                also has bangs that cover her forehead and fall along the sides
                of her face. Miyu's eye color is light red.
              </p>
            </div>
            <h4
            ...
            <div className="ml-3 mt-2">
              <p>
               See <a href="/miyu#halo" className="text-[#357ff3]">Kasumizawa Miyu</a>
              </p>
            </div>
                    ...
                    <img
                      src={
                        selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Miyu_Swimsuit_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Miyu_Swimsuit_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Miyu_Halo.png"
                          : selectedTab === "default"
                          ? "/Blue-Archive/characters/Miyu_Swimsuit_Portrait.png"
                          : "/Blue-Archive/characters/Miyu_Swimsuit_Icon.png"
                      }
                      alt={`Miyu_Swimsuit ${
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#ebe8ef] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">3093</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#90abc9]">
                        ATK
                      </span>
                      <span className="font-bold text-lg text-black">232</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#90abc9]">
                        DEF
                      </span>
                      <span className="font-bold text-lg text-black">103</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#90abc9]">
                        HEAL
                      </span>
                      <span className="font-bold text-lg text-black">1625</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#ebe8ef] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">23127</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2328</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">618</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4877</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#ebe8ef] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">24284</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2561</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">618</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5243</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#ebe8ef] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">25903</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2841</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">618</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5731</span>
                    </div>
                  </div>
                   <div className="flex items-center justify-between mb-2">
                    <span className="font-extrabold text-[#ebe8ef] text-sm">
                  ...
                  <div className="bg-[#ebe8ef] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">27984</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3167</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">618</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">6316</span>
                    </div>
                  </div>
                   <div className="flex items-center justify-between mb-2">
                    <span className="font-extrabold text-[#ebe8ef] text-sm">
                  ...
                  <div className="bg-[#ebe8ef] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">31222</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3562</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">618</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">7048</span>
                    </div>
                  </div>
                  {/* Profile Dropdown */}
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
           Miyu (swimsuit) wears a white two-piece crop swimsuit with a yellow and green leaf pattern.
            Additionally, she wears a straw hat that rests on her back.
            </p>
          </div>
          <h4
            className="text-[#3e7af2] text-lg font-bold ml-3 mt-4"
          ...
          <div className="ml-3 mt-2">
            See <a href="/miyu#firearm" className="text-[#357ff3]">Kasumizawa Miyu</a>
          </div>
          <h2
                    ...
                    <tbody>
                      <tr>
                        <td className="w-1/4 bg-[#90abc9] p-2">
                          <img
                            src="Blue-Archive/icons/AlWAYS_CRITICAL.png"
                          ...
                          <ul className="list-disc list-inside space-y-1">
                            <li>
                              ...
                              <span className="text-[#90abc9] font-bold">
                                ...
                                of ATK as guaranteed CRIT.DMG to enemies in in a{" "}
                              <span className="text-[#90abc9] font-bold">
                                straight-line
                              </span>{" "}
                            </li>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#90abc9] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                             369, 388, 406, 480, 499, 517, 591, 610, 628, 702,
                            ].map((dmg, idx) => {
                              return (
                                <li key={idx}>
