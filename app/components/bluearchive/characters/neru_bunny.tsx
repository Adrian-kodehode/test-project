...
const NeruBunnyLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Neru_Bunny_Girl_Live2D.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const NeruBunnyEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Neru_Bunny_Girl_EX.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
    ...
    >
      ...
      <main className="flex-1 mt-10 mb-10 w-[1300px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#4f86f7] w-[400px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-40 rounded">
              <span className="block text-center w-full italic">
                “ ...An? A sukajan? I can't give this up, no matter what I wear.
                ”
              </span>
              <br />
            ...
            <p className="mt-5 max-w-[600px]">
              <strong>Mikamo Neru (Bunny Girl ver.)</strong> (美甘ネル
            ...
            <div className="ml-3 mt-2">
              <p>
                This is Neru, the leader of "C&C", who has changed into a bunny
                girl costume for her mission! She seems to be putting up with a
                lot of costumes that she would never normally wear for a
                mission, but she still won't take off her sukajan.
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
            ...
            <div className="ml-3 mt-2">
              <p>
                Neru has salmon pink hair in a braid tied with a couple tag
                accessories. She has a long hair strand hanging on her head.
              </p>
            </div>
            <h4
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Neru_Bunny_Girl_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Neru_Bunny_Girl_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Neru_Bunny_Girl_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Neru_Halo.png"
                          : "/Blue-Archive/characters/Neru_Bunny_Girl_Icon.png"
                      }
                      alt={`Hikari ${
              ...
              <table className="w-full border-separate border-spacing-y-2">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="bg-[#ccccff] px-2 py-2 text-center align-middle w-1/3">
                      <img
                        src="/Blue-Archive/weapons/SMG_New_Icon.png"
                        alt="Handgun Icon"
                        width={80}
                        height={48}
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">3040</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#4f86f7]">
                        ATK
                      </span>
                      <span className="font-bold text-lg text-black">185</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#4f86f7]">
                        DEF
                      </span>
                      <span className="font-bold text-lg text-black">27</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#4f86f7]">
                        HEAL
                      </span>
                      <span className="font-bold text-lg text-black">1802</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">42146</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">1849</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">162</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5404</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">45533</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2061</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">162</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5956</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">50801</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2318</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">162</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">6646</span>
                    </div>
                  </div>
                  {/* Profile Dropdown */}
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
              She wears a typical velvet red bunny suit with a white collar, a
              red bow tie, and velvet red bunny ears. Around her arms, she wears
              a cherry-blossom patterned black and white street jacket. She has
              multiple bandages on her right leg, along with red high heels.
            </p>
          </div>
          <h4
            className="text-[#3e7af2] text-lg font-bold ml-3 mt-4"
                    ...
                    <tbody>
                      <tr>
                        <td className="w-1/4 bg-[#4f86f7] p-2">
                          <img
                            src="Blue-Archive/icons/EVASION.png"
                        ...
                        <td className="w-3/4 border-l-2 border-[#4f86f7] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            <li>
                              <span className="font-bold">LV01</span> ~ Move to location, than cast{" "}
                            ...
                            <li>
                              <span className="font-bold">LV02</span> ~ Move to location, than cast{" "}
                              <span className="text-[#4f86f7] font-bold">
                                297%
                              </span>{" "}
                              of HEAL as a{" "}
                            ...
                            <li>
                              <span className="font-bold">LV03</span> ~Move to location, than cast{" "}
                              <span className="text-[#4f86f7] font-bold">
                                336%
                              </span>{" "}
                              of HEAL as a{" "}
                            ...
                            <li>
                              <span className="font-bold">LV04</span> ~ Move to location, than cast{" "}
                              <span className="text-[#4f86f7] font-bold">
                                359%
                              </span>{" "}
                              of HEAL as a{" "}
                            ...
                            <li>
                              <span className="font-bold">LV05</span> ~ Move to location, than cast{" "}
                              <span className="text-[#4f86f7] font-bold">
                                401%
                              </span>{" "}
                              of HEAL as a{" "}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#4f86f7] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              22.1, 23.2, 24.3, 28.7, 29.8, 30.9, 35.3,
                              36.4, 37.5, 41.9
                            ].map((dmg, idx) => {
                              return (
                                <li key={idx}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#4f86f7] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                             3.2, 3.4, 3.5, 4.2, 4.4, 4.5, 5.2, 5.4, 5.5, 6.2
                            ].map((bar, i) => (
                              <li key={i}>
                                <span className="font-bold">
                                  LV{(i + 1).toString().padStart(2, "0")}
                                ...
                                of ATK as additional DMG when attacking{" "}
                                <span className="text-[#4f86f7] font-bold">
                                 medium-sized
                                </span>{" "}
                              enemies.
                    ...
                    <tr>
                      <td className="border-2 border-[#4f86f7] p-2 flex items-center justify-center">
                        <img
                          ...
                          alt="Shield Buff Icon"
                          className="w-9 h-10 mx-auto"
                        />
                        <img
                          src="Blue-Archive/icons/CC_-_Provoke.png"
                          alt="Shield Buff Icon"
                          className="w-9 h-10 mx-auto"
                        />
                      </td>
                      <td className="border-2 border-[#4f86f7] p-2">
                        <img
                          src="Blue-Archive/icons/Buff_-_EVA.png"
                          alt="Cross Icon"
                          className="w-9 h-10 mx-auto"
                        />
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border-2 border-[#4f86f7]">
                        <div className="relative inline-block">
                          ...
                          <div>
                            <img
                              src="Blue-Archive/icons/Crystal_Haniwa_0.png"
                              alt=""
                              className="w-12 h-10"
                            />
                          </div>
                    ...
                    <tr>
                      ...
                      <td className="border-2 border-[#4f86f7]">
                        <div className="relative inline-block">
                          ...
                          <div>
                            <img
                              src="Blue-Archive/icons/Crystal_Haniwa_1.png"
                              alt=""
                              className="w-12 h-10"
                            />
                          </div>
                    ...
                    <tr>
                      ...
                      <td className="border-2 border-[#4f86f7]">
                        <div className="relative inline-block">
                          ...
                          <div>
                            <img
                              src="Blue-Archive/icons/Crystal_Haniwa_2.png"
                              alt=""
                              className="w-12 h-10"
                            />
                          </div>
                    ...
                    <tr>
                      ...
                      <td className="border-2 border-[#4f86f7]">
                        <div className="relative inline-block">
                          ...
                          <div>
                            <img
                              src="Blue-Archive/icons/Crystal_Haniwa_3.png"
                              alt=""
                              className="w-12 h-10"
                            />
                          </div>
