...
const ShirokoSwimsuitLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Shiroko_Swimsuit_Live2D.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const ShirokoSwimsuitEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Shiroko_Swimsuit_EX.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
    ...
    >
      ...
      <main className="flex-1 mt-10 mb-10 w-[1300px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
        <h2 className="text-4xl mt-10 mb-10 ml-5 text-[#06bbfa]">
          Sunaookami Shiroko (Swimsuit ver.)
        </h2>
        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#06bbfa] w-[400px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-40 rounded">
            ...
            <p className="mt-5 max-w-[600px]">
              <a href="">
                {" "}
                <strong>Sunaookami Shiroko (Swimsuit ver.)</strong> (砂狼シロコ
                (水着Ver.)) is the
              </a>{" "}
              Summer Variant of{" "}
              <a href="/shiroko" className="text-[#357ff3]">
                Shiroko
              </a>{" "}
              and is one of the{" "}
            ...
            <div className="ml-3 mt-2">
              <p>
                Shiroko, the leader of the Abydos Countermeasures Committee, has
                arrived at a desert island resort in the middle of summer! She
                is taking the lead in gathering food and seems to be excited
                about the "survival" situation. Even after changing into her
                swimsuit, Shiroko seems to be going at her own pace.
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
            ...
            <div className="ml-3 mt-2">
              <p>
                Shiroko is a petite young woman with grey hair tied in a
                ponytail, complemented by a pair of wolf ears. The insides of
                her wolf ears are lined with white fluff, which protrudes
                slightly. She has a single cyan stud ear piercing on her right
                ear. Her eyes have mismatched, slitted pupils, with the left one
                being white.
              </p>
            </div>
            <h4
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Shiroko_Swimsuit_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Shiroko_Swimsuit_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Shiroko_Swimsuit_Sprite.png"
                          : selectedTab === "halo"
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">2204</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#06bbfa]">
                        ATK
                      </span>
                      <span className="font-bold text-lg text-black">371</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#06bbfa]">
                        DEF
                      </span>
                      <span className="font-bold text-lg text-black">65</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#06bbfa]">
                        HEAL
                      </span>
                      <span className="font-bold text-lg text-black">1923</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">16461</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3715</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">393</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5767</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">17784</span>
                    </div>
                    <div className="flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">6356</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#ccccff] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">19841</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4659</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">393</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">7093</span>
                    </div>
                  </div>
                  {/* Profile Dropdown */}
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
              Shiroko (swimsuit) wears a black bodysuit as swimsuit. Her
              swimsuit is black with cyan color on the sides.
            </p>
          </div>
          <h4
            className="text-[#3e7af2] text-lg font-bold ml-3 mt-4"
            ...
            <div className="mt-4 space-y-6">
              ...
              {activeSkillTab === "normal" && (
                <div className="overflow-x-auto">
                  <table className="w-[950px] border-2 border-[#06bbfa] rounded-lg">
                    <thead>
                      <tr>
                        <th
                          colSpan={2}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#06bbfa] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              11.5, 12.1, 12.7, 15, 15.5, 16.1, 18.4, 19, 19.6,
                              21.9,
                            ].map((dmg, idx) => {
                              return (
                                <li key={idx}>
                                  ...
                                  ~ When the battle starts, increases ally
                                  CRIT.R excluding the user, by{" "}
                                  <span className="text-[#06bbfa] font-bold">
                                    {dmg}%
                                  </span>{" "}
                                  (
                                  ...
                                  sec) and decreases EX-Skill cost by{" "}
                                  <span className="text-[#06bbfa] font-bold">
                                    1
                                  </span>
                                  . (for{" "}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#06bbfa] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              10.6, 11.2, 11.7, 13.8, 14.4, 14.9, 19, 17.6,
                              19.1, 20.2,
                            ].map((bar, i) => (
                              <li key={i}>
                                <span className="font-bold">
                ...
                <table className="w-full border-2 border-[#06bbfa] rounded-lg text-center">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border-2 border-[#06bbfa] p-2 flex justify-center items-center space-x-2">
                        <img
          ...
          <div className="mt-10">
            ...
            <div className="flex w-full">
              ...
              <section className="mt-8 mb-8 overflow-x-auto">
                <table className="w-[1250px] border-separate border-spacing-y-2 border-2 border-[#06bbfa] rounded-lg text-center">
                  <thead>
                    <tr>
