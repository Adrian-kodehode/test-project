...
const MiyuLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Miyu_Live2D.gif"
      alt="Miyu Live2D"
...
const MiyuEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Miyu_EX.gif"
      alt="Miyu EX Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
    ...
    >
      ...
      <main className="flex-1 mt-10 mb-10 w-[1300px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#90abc9] w-[350px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-20 right-20 rounded">
              ...
              <span className="absolute right-20 bottom-1 text-xs italic">
                ~ Kasumizawa Miyu <a href="#" className="text-[#357ff3]"></a>
              </span>
            </div>
            <p className="mt-5 max-w-[600px]">
              <strong>Kasumizawa Miyu (霞沢ミユ) </strong>is one of the{" "}
            ...
            <div className="ml-3 mt-2">
              <p>
                Miyu, a member of the RABBIT platoon, entered SRT because she
            ...
            <div className="ml-3 mt-2">
              <p>
                Despite Miyu being a capable sniper, she is a very shy person
            ...
            <div className="ml-3 mt-2">
              <p>
                Miyu appears to be a shy petite girl, she is just 149 cm. She
                ...
                Miyu's eye color is light red. She also wears a small rabbit
            ...
            <div className="ml-3 mt-2">
              <p>
                Miyu's halo is a light grey colour formed with an inner little
                    ...
                    <img
                      src={
                        selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Miyu_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Miyu_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Miyu_Halo.png"
                          : selectedTab === "gym"
                          ? "/Blue-Archive/characters/Miyu_Gym_Portrait.png"
                          : selectedTab === "default" ||
                            selectedTab === "Default"
                          ? "/Blue-Archive/characters/Miyu_Portrait.png"
                          : "/Blue-Archive/characters/Miyu_Icon.png"
                      }
                      alt={`Miyu ${
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
              Miyu wears a japanese sailor style school uniform, that consist
                        ...
                        <td className="w-3/4 border-l-2 border-[#90abc9] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            <li>
                              ...
                              of Miyu's ATK as additional DMG every time an
