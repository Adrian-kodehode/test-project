...
const AkaneBunnyLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Akane_Bunny_Girl_Live2D.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const AkaneBunnyEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Akane_Bunny_Girl_EX.gif"
      alt="Hoshino Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#4f86f7] w-[400px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-40 rounded">
              <span className="block text-center w-full italic">
                “ I wish to be of service to my master, both as a maid and as a
                rabbit. ”
              </span>
              <br />
              <span className="absolute right-15 bottom-1 text-xs italic">
                ~ Murokasa Akane (Bunny Girl ver.)
              </span>
            </div>
            <p className="mt-5 max-w-[600px]">
              <strong>Murokasa Akane (Bunny Girl ver.)</strong> (室笠アカネ
            ...
            <div className="ml-3 mt-2">
              <p>
                It's Akane, an agent of C&C who will be directly participating
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Akane_Bunny_Girl_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Akane_Bunny_Girl_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Akane_Bunny_Girl_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Akane_Halo.png"
                          : "/Blue-Archive/characters/Akane_Bunny_Girl_Icon.png"
                      }
                      alt={`Hikari ${
                    ...
                    <tbody>
                      <tr>
                        <td className="w-1/4 bg-[#4f86f7] p-2">
                          <img
                            src="Blue-Archive/icons/BATTLE-ITEM.png"
