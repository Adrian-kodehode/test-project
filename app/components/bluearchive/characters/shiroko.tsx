...
const ShirokoLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Shiroko_Live2D.gif"
      alt="Shiroko Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
));
const ShirokoEX = memo(() => (
  <div className="bg-[#06bbfa] flex flex-col space-y-2 p-5">
    <img
      src="Blue-Archive/icons/SHIROKO_EX-SKILL.png"
      alt="Shiroko EX Live2D"
      className=" w-full rounded-lg mx-auto "
    />
  </div>
));

export const Shiroko = () => {
      ...
      <main className="flex-1 mt-10 mb-10 w-[1300px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
        ...
        <div className="flex flex-row gap-8 items-start">
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#06bbfa] w-[350px] text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 left-20 right-20 rounded">
              ...
              <span className="absolute right-20 bottom-1 text-xs italic">
                ~ Sunaookami Shiroko <a href="#" className="text-[#357ff3]"></a>
              </span>
            </div>
            <p className="mt-5 max-w-[600px]">
              <strong>Sunaookami Shiroko (砂狼シロコ) </strong>is one of the{" "}
            ...
            <div className="ml-3 mt-2">
              <p>
                The sports-loving field captain of the Countermeasures Committee
                of the Abydos High School. Shiroko is a girl of few words and
                shows little emotions alike. She may seem aloof with her
                appearance, but deeply cares about Abydos High School the most.
              </p>
              <p className="mt-5">
                Due to troubling circumstances happening in Abydos High School,
                she is willing to do anything to revitalize the school by any
                means. Often times though her ideas are sometimes ridiculous
                like proposing to rob a bank for school funds.
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
            ...
            <div className="ml-3 mt-2">
              <p>
                Shiroko is a soft-spoken girl, who deeply cares for her friends,
                to the extent that she would do anything to help her friends
                towards their goal of revitalizing the school. Though she is
                generally calm and reserved, she hyperfocuses on certain
                interests and can sometimes be oblivious to how others would
                react to them.
              </p>
              <p className="mt-5">
                She often bikes and walks far more than regular people can keep
                up, thinking distances of 10s of kilometers are average for her.
                She fantasizes about robbing banks and going on survival fishing
                trips, and being unable to do either of these things causes her
                to pout and act with remarkable petulance for how calm she
                usually is.
              </p>
              <p className="mt-5">
                Shiroko is willing to fight Hina the moment she laid eyes on her
                despite the head prefect's reputation, stopping only at Ayane's
                begging. She requires people like Sensei and Ayane to hold her
                back and keep her sensible.{" "}
              </p>
              <p className="mt-5">
                She also instinctively didn't like Wakamo for acting clingy
                towards Sensei, seeing how surprised Wakamo was at Sensei's
                presence and immediately filling her with lead in jealousy.
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
            ...
            <div className="ml-3 mt-2">
              <p>
                Shiroko appears to be a shy petite girl, she is just 149 cm. She
                ...
                Shiroko's eye color is light red. She also wears a small rabbit
            ...
            <div className="ml-3 mt-2">
              <p>
                Shiroko's halo is a light grey colour formed with an inner
                little circle, a middle circle split into four sides and four
                thick outer semicircles, one in every side of the middle circle.
                In addition it has three little drops scattered around it.
              </p>
            </div>
                    ...
                    <img
                      src={
                        selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Shiroko_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Shiroko_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Shiroko_Halo.png"
                          : selectedTab === "robber"
                          ? "/Blue-Archive/characters/Shiroko_Robber_Portrait.png"
                          : selectedTab === "young"
                          ? "/Blue-Archive/characters/Shiroko_Young_Portrait.png"
                          : selectedTab === "gym"
                          ? "/Blue-Archive/characters/Shiroko_Gym_Portrait.png"
                          : selectedTab === "default" ||
                            selectedTab === "Default"
                          ? "/Blue-Archive/characters/Shiroko_Portrait.png"
                          : "/Blue-Archive/characters/Shiroko_Icon.png"
                      }
                      alt={`Shiroko ${
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#aae5f8] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">2493</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#06bbfa]">
                        ATK
                      </span>
                      <span className="font-bold text-lg text-black">340</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#06bbfa]">
                        DEF
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">1662</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#aae5f8] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">24932</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3402</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">118</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4987</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#aae5f8] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">26935</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3792</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">118</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">5496</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#aae5f8] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">30052</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">4266</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">118</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">6133</span>
                    </div>
                  </div>
                  {/* Profile Dropdown */}
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
              She wears the standard Abydos High School uniform: a tucked, white
              dress shirt with a left breast pocket faintly embroidered with the
              school's logo and name, a cyan scarf with dark stripes, a cyan
              necktie with a navy blue cross mark at its blade, a navy blue
              blazer with silver buttons and white accents, a lime-green and
              cyan Abydos badge hanging off the left side of the blazer.
            </p>
            <p className="mt-5">
              She wears a pleated, dark grey and black skirt with a plaid
              pattern with white accents and wears white panties. She wears a
              single lime-green fingerless cycling glove on her left hand in her
              standard appearance.
            </p>
            <p className="mt-5">
              She carries a Japanese-style black shoulder bag with cyan and
              silver accents and a triangular designer logo, with three
              keychains: a lime green cat winking and smiling, a silver cross or
              ankh, and a pink heart. She wears knee-high socks with triangular
              logos, similar to the ones on her bag, near the cuffs of the
              socks. Her running shoes are black with white and lime green
              accents, cyan shoe laces, and lime green soles.
            </p>
          </div>
          <h4
            className="text-[#3e7af2] text-lg font-bold ml-3 mt-4"
          ...
          <div className="ml-3 mt-2">
            <div className="flex flex-row gap-8">
              ...
              <div className="flex-1">
                <p>
                  She uses a white SIG SG 550 assault rifle customized with a
                  lower receiver from an M4 as well as a black suppressor and
                  vertical grip. The charging handle and fire selector switch is
                  painted cyan. It is equipped with a SUSAT L9A1 sight with a
                  blue lens. An Abydos emblem is stamped on the mag well. The
                  phrase "ABYDOS 550" is written on the suppressor.
                </p>
                <p className="mt-5">
                  For her EX skill she deploys a white flying drone with black
                  and cyan accents, equipped with two rotors and two missile
                  pods.
                </p>
              </div>
              {/* Images (right) */}
              <div className="flex flex-col gap-4">
                <img
                  src="https://static.wikia.nocookie.net/blue-archive/images/b/b2/Shiroko_UE_Schematic.png"
                  alt="WHITE FANG 465"
                  className="w-60 h-auto"
                />
                <img
                  src="https://static.wikia.nocookie.net/blue-archive/images/9/95/Missile_Drone_Concept.png/"
                  alt="Missile Drone"
                  className="w-60 h-auto"
                />
              </div>
            ...
            <div className="mt-4 space-y-6">
              ...
              {activeSkillTab === "ex" && (
                <div className="overflow-x-auto rounded">
                  <table className="w-[800px] border-2 border-[#06bbfa] rounded-lg">
                    <thead>
                      <tr>
                        <th
                          colSpan={2}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#06bbfa] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              193, 203, 213, 251, 261, 271, 309, 319, 329, 368,
                            ].map((dmg, idx) => {
                              return (
                                <li key={idx}>
                                  ...
                                  <span> of ATK as DMG to enemies in a </span>
                                  <span className="text-[#06bbfa] font-bold">
                                round-shaped
                                  </span>
                                   <span> area every </span>
                                  <span className="text-[#06bbfa] font-bold">
                                  25
                                  </span>
                                 <span> sec.</span>
              ...
              {activeSkillTab === "sub" && (
                <div className="overflow-x-auto">
                  <table className="w-[1035px] border-2 border-[#06bbfa] rounded-lg">
                    <thead>
                      <tr>
                        <th
                          colSpan={2}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#06bbfa] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              30.2, 31.7, 33.2, 39.3, 40.8, 42.3, 48.3, 49.9,
                              51.4, 57.4,
                            ].map((bar, i) => (
                              <li key={i}>
                                <span className="font-bold">
                               ...
                               <span> ~ Has a </span>
                                ...
                                <span> chance to increase ATK SPD by </span>
                                <span className="text-[#06bbfa] font-bold">
                                 {bar}%
                                </span>
                               <span> when dealing Normal Attack. Last for </span>
                               <span className="text-[#06bbfa] font-bold">30</span>
                               <span> sec (CD </span>
                               <span className="text-[#06bbfa] font-bold">25</span>
                               <span> sec).</span>
                              </li>
                            ))}
                          </ul>
