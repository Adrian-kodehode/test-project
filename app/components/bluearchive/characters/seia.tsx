...
const SeiaLive2D = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/characters/Seia_Icon_2.png"
      alt="Hoshino Live2D"
...
const SeiaEX = memo(() => (
  <div className="flex flex-col space-y-2">
    <img
      src="Blue-Archive/live2d/Seia_EX.gif"
      alt="Seia EX Live2D"
      className="w-full rounded-lg mx-auto "
    />
  </div>
        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-1 mt-5 ml-3">
            ...
            <p className="mt-5 max-w-[600px]">
              <strong>Yurizono Seia (百合園セイア)</strong> is one of the{" "}
            ...
            <div className="ml-3 mt-2">
              <p>
                Seia is one of the three presidents of the Tea Party. Compared
                to the other two presidents, Seia has a distinctive way of
                speaking as her choice of vocabulary differs from the others.
                Seia is also known to have prophetic dreams which can predict
            ...
            <div className="ml-3 mt-2">
              <p>
                Seia is rather philosophical when she talks. This is possibly
            ...
            <div className="ml-3 mt-2">
              <p>
                Seia has champagne yellow, straight hair, that reaches down
            ...
            <div className="ml-3 mt-2">
              <p>
                Seia's halo consists of two yellow lines, which resemble Roman
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Seia_Icon.png"
                          : selectedTab === "portrait"
                          ? "/Blue-Archive/characters/Seia_Portrait.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Seia_Sprite.png"
                          : selectedTab === "halo"
