        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-1 mt-5 ml-3">
            ...
            <div className="ml-3 mt-2">
              <p>
                Member of the Supplementary Lesson Department of Trinity General
                Academy.
              </p>
              <p className="mt-5">
                Originally, she belonged to the{" "}
                <a href="#" className="text-[#3e7af2]">
                  Justice Realization Committee
                </a>
                , but her grades fell and she fell into a crisis of repeating a
                year and was placed in the Make-Up Work club. She thinks she is
                an elite, but in reality, she is too stupid to keep up with her
                schoolwork. She has a hobby of collecting lewd magazines, and
                often sees sexual elements to even the most trivial of things.
              </p>
            </div>
            <h3
              className="text-[#3e7af2] text-xl font-bold ml-3 mt-4"
            ...
            <div className="ml-3 mt-2">
              ...
              <p className="mt-5">
                Notably, she expresses a strong prudishness, calling out
                anything remotely suggestive and/or lewd. Despite this, she is
                often caught having doujins and other explicit material, a
                clearly hypocritical behavior. Because of her delusions, she
                also believes that Sensei has strong sexual fantasies towards
                her and fully expects to be ravaged by them, though she often
                denies this in turn. She is a girl struggling to reconcile her
                own personal standards with her burgeoning adolescence.
              </p>
              <p className="mt-5">
                However, beneath it all she is a dependable person who provides
                lighthearted banter and a springboard to bounce off of for the
                  ...
                  <tr>
                    ...
                    <td className="bg-[#f7e69a] px-2 py-2  text-center align-middle w-1/3">
                      <div className="flex flex-col items-center justify-center">
                        <img
                          src="/Blue-Archive/icons/Healer (1).png"
                          alt="Healer"
                          width={20}
                          height={20}
                ...
                <div className="mt-4">
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 pt-3 pb-2 mb-2">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">2729</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#fbb35a]">
                        ATK
                      </span>
                      <span className="font-bold text-lg text-black">254</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-xs font-bold text-[#fbb35a]">
                        DEF
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="font-bold text-lg text-black">2530</span>
                    </div>
                  </div>
                  {/* Level 100 Row 1 */}
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">23655</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2544</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">146</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">7592</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-2 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">25556</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">2836</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">146</span>
                    </div>
                  ...
                  <div className="bg-[#f7e69a] grid grid-cols-4 gap-2 mb-4 pt-3 pb-2">
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">28513</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">3191</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="font-bold text-black">146</span>
                    </div>
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
              ...
              shoulder, revealing a white bra strap.
            </p>
          </div>
          <h4
            className="text-[#3e7af2] text-lg font-bold ml-3 mt-4"
          ...
          <div className="ml-3 mt-2">
            She uses a black Pattern 1914 Enfield bolt action battle rifle with
            pink retaining bands. A snail charm hangs on the forward rifle sling
            point. Her club's name is stamped on the receiver furniture. Her
            rifle is wrapped in a black shroud when not in use.
          </div>
          <h2
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            <li>
                              ...
                              <span> of HEAL as HP for allies within a </span>
                              <span className="text-[#fbb35a] font-bold">
                                round-shaped
                              </span>
                              <span> area and deals </span>
                              <span className="text-[#fbb35a] font-bold">
                                227%
                              </span>{" "}
                              <span> of ATK as damage to enemies.</span>
                            </li>
                            <li>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              80.8, 84.9, 88.9, 105, 109, 113, 129, 133, 137, 153,
                            ].map((dmg, idx) => {
                              const stunDurations = [
                              ...
                              return (
                                ...
                                <span> of HEAL as HP only for allies whose HP is </span>
                                  <span className="text-[#fbb35a] font-bold">
                                    50%
                                  </span>
                                  <span> or lower. (CD: </span>
                                  <span className="text-[#fbb35a] font-bold">
                                    20
                                  </span>
                                  <span> sec).</span>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="w-3/4 border-l-2 border-[#fbb35a] p-4 text-xs">
                          <ul className="list-disc list-inside space-y-1">
                            {[
                              21.5, 22.6, 23.7, 28, 29.1, 30.2, 34.5, 35.6, 36.6, 41,
                            ].map((bar, i) => (
                              <li key={i}>
                                <span className="font-bold">
                                  LV{(i + 1).toString().padStart(2, "0")}
                                </span>{" "}
                                ~ Increases HEAL by <span className="text-[#fbb35a] font-bold">
                                  {bar}%
                                </span>{" "}
                                <span>every </span>
                              <span className="text-[#fbb35a] font-bold">30 </span>
                              <span>sec (</span>
                                <span className="text-[#fbb35a] font-bold">
                                  20
                                </span>{" "}
