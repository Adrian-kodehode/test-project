...
const HoshinoSwimsuitLive2D = memo(() => (
    ...
    >
      ...
      <main className="flex-1 mt-10 mb-10 w-[1200px] max-w-[98vw] bg-black bg-opacity-80 rounded-lg p-4 text-white shadow-lg mx-auto ">
        <h2 className="text-4xl mt-10 mb-10 ml-5 text-[#06bbfa]">
          Takanashi Hoshino (Swimsuit ver.)
        </h2>
        ...
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-1 mt-5 ml-3">
            <div className="bg-[#06bbfa] w-[450px] left-36 text-black flex flex-col items-center justify-center relative py-3 px-4 pt-5 rounded">
              <span className="block text-center w-full italic">
                “ C'mere Sensei~ It's nice and cool here, yknow? ”
              </span>
              <br />
            ...
            <p className="mt-5 max-w-[600px]">
              <strong> Takanashi Hoshino (Swimsuit ver.)</strong> (小鳥遊ホシノ
            ...
            <div className="ml-3 mt-2">
              <p>
                Here is Hoshino who arrived at an uninhabited island in hopes of
                a lax summer. Although Hoshino is normally lazy and thinks of
                everything as a pain, it seems that she, too, was affected by
                the Summer mood and appears to be a bit more active than usual;
                though, the person in question doesn't seem to have noticed
                this.
              </p>
            </div>
            <h3
            ...
            <div className="ml-3 mt-2">
              <p>
                Hoshino has thigh-length pink hair tied into two sections with
                red hairpins. She has heterochromia, with one blue eye and one
                orange eye.
              </p>
            </div>
            <h4
          ...
          <aside className="bg-[#06bbfa] border-2 border-[#357ff3] rounded-lg shadow-lg p-6 mt-5 w-full max-w-xs mb-8 mr-5">
            ...
            <section>
              ...
              <div className="flex justify-center">
                <ul className="flex justify-between">
                  {[{ label: "Robber", key: "robber" }].map((tab) => (
                    <li key={tab.key}>
                      <button
                        type="button"
                        className={`px-4 py-2 text-[#aae5f8] font-${
                ...
                <figure>
                  <a href="#">
                    <img
                      src={
                        selectedTab === "icon"
                          ? "/Blue-Archive/characters/Hoshino_Swimsuit_Icon.png"
                          : selectedTab === "sprite"
                          ? "/Blue-Archive/characters/Hoshino_Swimsuit_Sprite.png"
                          : selectedTab === "halo"
                          ? "/Blue-Archive/characters/Hoshino_Halo.png"
                          : selectedTab === "robber"
                          ? "/Blue-Archive/characters/Hoshino_Swimsuit_Robber_Icon.png"
                          : "/Blue-Archive/characters/Hoshino_Swimsuit.png"
                      }
                      alt={`Hoshino ${
        ...
        <div className="ml-3">
          ...
          <div className="ml-3 mt-2">
            <p>
              Hoshino wears a white frilly two-piece swimsuit and sandals, while
              sporting a beach jacket above them. She tops off the look with
              white-frame blue sunglasses. She also carries a huge translucent,
              dark blue whale floatie.
            </p>
          </div>
          <h4
            className="text-[#3e7af2] text-lg font-bold ml-3 mt-4"
          ...
          <div className="ml-3 mt-2 space-y-5">
            See{" "}
            <a href="/hoshino#halo" className="text-[#3e7af2] hover:underline">
              Takanashi Hoshino
            </a>
            <p className="mt-5">
              While keeping her original Eye of Horus, Swimsuit Hoshino switched
              out her regular Iron Horus ballistic shield for a bulletproof
              glass EMIHORUS shield.
            </p>
          </div>
          <h2
          ...
          <div className="mt-10">
            ...
            <div className="flex w-full">
              ...
              <div className="w-1/3 bg-black bg-opacity-50 p-4 flex items-center justify-center">
                <img
                  src="Blue-Archive/live2d/Hoshino_Swimsuit_EX.gif"
                  alt="EX Skill"
                  className="w-full"
                />
              </div>
