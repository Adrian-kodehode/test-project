    ...
    <div className="ml-64 flex-1">
      ...
      <div className="bg-[#fcc0e9] flex flex-row items-start justify-center min-h-screen">
        ...
        <div className="flex-1 text-black bg-white pl-8 pr-8 pt-8 h-screen max-w-4xl">
          <h1 className="mb-2 pt-5 text-5xl">Anime</h1>
            ...
            {[
              {
                ...
                link: "/motto_to_love-ru_anime",
              },
              {
                src: "To Love Ru/toloveruanime.jpg",
                title: "To LOVE-Ru (anime)",
                link: "/to_love-ru_anime",
              },
              {
                src: "To Love Ru/toloverudarknessanime.jpg",
                title: "To LOVE-Ru Darkness (anime)",
                link: "/to_love-ru_darkness_anime",
              },
              {
                src: "To Love Ru/toloverudarkness2nd.jpg",
                title: "To LOVE-Ru Darkness 2nd",
                link: "/to_love-ru_darkness2ndanime",
              },
            ].map((item, i) => (
