    ...
    <div className="bg-[#FFF4FB] flex flex-row items-start min-h-screen">
      ...
      <div className="flex-1 text-black pl-8 pr-8 pt-8 max-w-2xl">
        <p>
          ...
          assassin who is initially hired by Lacospo, one of Lala's arranged
          suitors, to kill Yuuki Rito. But when Lacospo effectively annuls the
          job, she decides to take her time and, under the pretense of still
          needing to complete her mission to kill Rito, stays on Earth. As she
          spends more time on Earth, she builds a very strong relationship with
          Rito's mature younger sister, Yuuki Mikan and to Rito himself, whom
          she also develops feelings for.
        </p>
        <br />
        <p>
          In To Love-Ru Darkness, Yami becomes central to the main plot. This is
          because there is a group that wants her to join them as the heartless
          assassin she once was. Her "sister", Kurosaki Mea (a transformation
          weapon of the same program that created Yami) and a mysterious figure
          known as Nemesis, arrive to Earth to take her away and revive the old
