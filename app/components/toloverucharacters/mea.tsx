      ...
      <div className="bg-[#FFF4FB] flex flex-row items-start justify-center min-h-screen">
        ...
        <div className="flex-1 text-black pl-8 pr-8 pt-8 max-w-2xl">
          <p>
            ...
            Darkness. She is sent to Earth to bring back the "old" Yami. It is
            revealed that she is Yami's younger sister as she was created by the
            same organization and from the same project (Project Eve) as her. At
            first she is found alone staring out the window until she meets Nana
            and becomes friends with her. She now views others as friends. It
            appears that she has sexual, though not necessarily emotional,
            feelings towards Rito, although she tends to use them in a playful,
            teasing way around him.
          </p>
          <br />
          <p>
